  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'pwd' ? 'http://127.0.0.1:3000/api/v1/users/updatePassword' : 'http://127.0.0.1:3000/api/v1/users/updateMe';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripePromise = (0, _stripeJs.loadStripe)('pk_test_51RTM8UB4vxGrQHecg98WdYR8bbzI3JvwvwUeU0zWKErdBN3AwUYWMagdldHcKchB35qnCZzfP5YrfqUBxPbZF8xK00NiQ2aGXS');
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    var stripe, sessionRes, session, result;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
        ...
        case 8:
          ...
          session = sessionRes.data.session; // Redirect to Stripe Checkout
          _context.next = 13;
...
},{"@stripe/stripe-js":"../../node_modules/@stripe/stripe-js/lib/index.mjs","axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"signup.js":[function(require,module,exports) {
"use strict";
...
var signup = exports.signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, email, pwd, pwdCnfrm) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
...
if (signupform) {
  signupform.addEventListener('submit', function (e) {
    ...
    (0, _signup.signup)(name, email, pwd, pwdCnfrm);
  });
}
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            pwdCnfrm = document.getElementById('password-confirm').value;
            _context.next = 7;
